...
# Với đường chéo chính, ta sẽ chia ma trận thành 2 nửa, được gọi là nửa trên và nửa dưới của đường chéo chính 
# (không tính các phần tử nằm trên đường chéo chính).
